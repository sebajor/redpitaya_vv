...
HD_PWD='/home/seba/Workspace/projects/redpitaya_vv/dev_4/dev_4.runs/system_bram_intf_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_bram_intf_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_bram_intf_0_0.tcl
